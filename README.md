# Python-Study-Group-Hands_on-Practice-Exercise
This Comprises the culmination of all courses taken in my python class for first semester. It includes: Getting Familiar with the python Interactive shell, the use Jupyter notebook, Hands on practice in Variable Assignment, Arithmetic and Comparison Operator, Logical Operators, Assignment Operators and String Formating amongst Others.
...
* **Key Tasks**:
  ...
  * Capturing user inputs using `input()`.
...
* **Key Tasks**:
  ...
  * **Student Evaluation**: Calculates subject averages to check pass status.
...
* **Key Tasks**:
  ...
  * Evaluating scholarship eligibility based on scores and income status.
...
* **Key Tasks**:
  ...
  * **Payroll System**: Calculating tax amounts (7.5%) and outputting formatted gross/net values in Naira (`₦`).
...
Clone the repository and launch Jupyter Notebook to run any file:
```bash
jupyter notebook
